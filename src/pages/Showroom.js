...
function Showroom() {
  const models = [
    { name: 'Layout Expand A', size: 'small' },
    { name: 'Layout Expand B', size: 'small' },
    { name: 'Layout Expand C', size: 'large' },
    { name: 'Layout Expand D', size: 'large' },
    { name: 'Layout Expand E', size: 'large' }
  ];
